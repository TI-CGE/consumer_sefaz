...
public class BaseDespesaCredorDTO extends EndpontSefaz {
    ...
    @JsonProperty("qtReforcada")
    private Integer qtReforcada;
    
    @JsonProperty("vlTotalItens")
    ...
    // Campos de retorno técnico para logging
    ...
    public void mapearCamposResposta() {
        ...
        camposResposta.put("vl_empenhado_atual", vlEmpenhadoAtual);
        ...
        camposResposta.put("qt_reforcada", qtReforcada);
        camposResposta.put("vl_total_itens", vlTotalItens);
    ...
    public Map<String, Object> getCamposParametrosTodosOsAnos(String ugCd, Short ano) {
        ...
        // Iniciar sempre pela primeira faixa
