...
public class TestProgressController {
    ...
    public String testProgress() {
        // Simular um consumo com barras de progresso no terminal
        new Thread(() -> {
            try {
                // Teste 1: Unidades Gestoras
    ...
    public String testMultipleProgress() {
        // Simular múltiplos consumos simultâneos
        ...
        // Thread 2: Pagamentos (começar um pouco depois)
        new Thread(() -> {
            try {
                Thread.sleep(2000);
